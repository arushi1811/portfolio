...
export default function Home() {
  return (
    <main>
      ...
      <div className="px-0 md:px-20 lg:px-20 pt-6 flex flex-col md:flex-row lg:flex-row justify-center items-center gap-4">
        <Subtitle highlight="About" after=" me." descr={aboutMeDescr} />
        <Stack />
      </div>
      <div className="px-0 md:px-20 lg:px-20 pt-40 flex flex-col justify-center items-center gap-4">
        <Subtitle before="Work " highlight="Experience." />
        <Workexp />
      </div>
      <div className="px-10 md:px-20 lg:px-20 pt-40 flex flex-col justify-center items-center gap-4">
        <Subtitle highlight="Portfolio" after="Projects." />
        <Portfolio />
      </div>
      <div className="h-20v md:h-10v lg:h-10v px-5 md:px-20 lg:px-20 flex flex-col md:flex-row lg:flex-row items-center justify-center md:justify-between lg:justify-between gap-4 md:gap-16 lg:gap-16 mt-20 rounded-t-3xl bg-gradient-to-r from-indigo-300 to-purple-300 dark:from-indigo-500 dark:to-purple-500">
        <ul className="flex items-center gap-6 md:gap-16 lg:gap-16">
        <h3 className="text-xl md:text-3xl lg:text-3xl font-bold">Get in touch!</h3>
          <a href="https://github.com/arushi1811" target='_blank'>
            <li className="h-6 w-6">
              <Github />
            </li>
          </a>
          <a href="https://www.linkedin.com/in/arushi18/" target='_blank'>
            <li className="h-8 w-8">
              <Linkedin />
            </li>
          </a>
          <a href="mailto:guptaarushi784@gmail.com">
            <li className="h-6 w-6">
              <Email />
            </li>
          </a>
        </ul>
        <h4 className="">HandMade by Me</h4>
      </div>
    </main>
  );
}
